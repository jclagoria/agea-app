...
<script src="http://code.jquery.com/ui/1.10.0/jquery-ui.js"></script>
	...
	<style>
		...
		.link {padding: 0px 30px 20px 30px; background-color: #f4f4f4; border: 1px solid #ccc; font-family: verdana; width: 500px; margin: 0 auto;  margin-top: 40px; margin-bottom: 40px;}
...
<body>
<div class="header"><h1>Agea App</h1></div>